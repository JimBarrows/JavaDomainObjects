...
public class CrmSteps {
	...
	public final void whenISaveTheCustomer() {
		final CustomerDto dto = new CustomerDto(null, fqnType(), name, firstName, lastName);
	...
	public final void givenATypeCustomerIsInTheDatabase(@Named("Type") final String type) {
		this.type = type;
	}
	...
	@Pending
	public final void givenTheNameIsName(@Named("Name") final String name) {
		this.name = name;
	}
