...
import mbmp.humanresoures.model.position.fulfillment.PositionFulfillment;
import mbmp.humanresoures.model.position.fulfillment.PositionStatus;
import mbmp.humanresoures.model.position.structure.PositionReportingStructure;
import mbmp.humanresoures.model.position.type.PositionType;
import mbmp.model.BaseDateRangeModel_;
import mbmp.party.model.Organization;

@Generated(value="Dali", date="2013-01-05T07:41:45.447-0700")
